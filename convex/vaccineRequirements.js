...
export const listByRequirement = query({
    args: {
        requirement: v.union(v.literal('required'), v.literal('recommended'), v.literal('consider')),
    },
    handler: async (ctx, args) => {
        return await ctx.db
            .query('vaccineRequirements')
...
export const update = mutation({
    args: {
        ...
        vaccineNameEn: v.optional(v.string()),
        requirement: v.optional(v.union(v.literal('required'), v.literal('recommended'), v.literal('consider'))),
