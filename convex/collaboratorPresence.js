 ...
 */
async function getAvailableColor(ctx, itineraryId) {
 ...
 */
async function checkAccess(ctx, itineraryId, userId) {
...
export const getOnlineCollaborators = query({
    ...
    handler: async (ctx, args) => {
        ...
        const onlinePresences = presences.filter((p) => p.isOnline && p.lastActiveAt > thirtySecondsAgo);
