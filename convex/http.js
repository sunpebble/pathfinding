    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return new Response(JSON.stringify({ success: true }), {
                ...
                headers: {
                    'Content-Type': 'application/json',
                    'Set-Cookie': 'convex-auth-token=; Path=/; HttpOnly; SameSite=Lax; Max-Age=0',
                },
            });
        }
        catch (error) {
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取指南列表失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '搜索失败', 500);
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            while (!isDone) {
                const batch = await ctx.runQuery(api.travelGuides.listDestinationsBatch, { cursor, batchSize: 50 });
            ...
            return errorResponse(error instanceof Error ? error.message : '获取目的地失败', 500);
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取指南失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取统计失败');
        }
    }),
});
// ============================================
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取会话列表失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '创建会话失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取消息失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '添加消息失败');
        }
    }),
});
// ============================================
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取粉丝列表失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取关注列表失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '取消关注失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '查询关注状态失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取问题列表失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '创建问题失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取回答列表失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '创建回答失败');
        }
    }),
});
// ============================================
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取笔记列表失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            const body = await request.json();
            const { userId, title, content, tags, visibility, coverImageUrl, imageUrls, destination, } = body;
            ...
            return errorResponse(error instanceof Error ? error.message : '创建笔记失败');
        }
    }),
});
// ============================================
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取预算失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '创建预算失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取支出列表失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '添加支出失败');
        }
    }),
});
// ============================================
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取通知失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '标记已读失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取未读数量失败');
        }
    }),
});
// ============================================
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '搜索POI失败');
        }
    }),
});
// ============================================
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '创建分享链接失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '记录事件失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取分类失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            const phrases = await ctx.runQuery(api.translations.listPhrasesByCategory, {
                category: category,
                sourceLang: sourceLang ?? undefined,
                limit,
            });
            ...
            return errorResponse(error instanceof Error ? error.message : '获取短语失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            const translations = await ctx.runQuery(api.translations.listSavedTranslations, {
                userId,
            ...
            return errorResponse(error instanceof Error ? error.message : '获取保存的翻译失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            const body = await request.json();
            const { userId, sourceText, sourceLang, targetText, targetLang, translationType, imageUrl, audioUrl, notes, } = body;
            if (!userId ||
                !sourceText ||
                !sourceLang ||
                !targetText ||
            ...
            return errorResponse(error instanceof Error ? error.message : '保存翻译失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '删除翻译失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            const isFavorite = await ctx.runMutation(api.translations.toggleFavorite, {
                id: id,
            });
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取离线包失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取任务列表失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '创建任务失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取任务失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '删除任务失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '启动任务失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '完成任务失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取报告列表失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '创建报告失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取报告失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '删除报告失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取摘要失败');
        }
    }),
});
// ============================================
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取数据集列表失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            const body = await request.json();
            const { name, version, generationParams, outputFormats, status, statistics, } = body;
            ...
            return errorResponse(error instanceof Error ? error.message : '创建数据集失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取数据集失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '删除数据集失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '更新数据集失败');
        }
    }),
});
// ============================================
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取汇率失败');
        }
    }),
});
/**
...
http.route({
    ...
    handler: httpAction(async (ctx, request) => {
        ...
        try {
            ...
            return errorResponse(error instanceof Error ? error.message : '获取汇率历史失败');
        }
    }),
});
/**
