...
export const listByUser = query({
    ...
    handler: async (ctx, args) => {
        ...
        const enriched = await Promise.all(collaborations.map(async (collab) => {
...
export const inviteCollaborator = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        const inviterCollab = await ctx.db
            .query('itineraryCollaborators')
            .withIndex('by_itinerary_user', (q) => q.eq('itineraryId', args.itineraryId).eq('userId', args.invitedBy))
            .first();
...
export const removeCollaborator = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        const removerCollab = await ctx.db
            .query('itineraryCollaborators')
            .withIndex('by_itinerary_user', (q) => q.eq('itineraryId', args.itineraryId).eq('userId', args.removedBy))
            .first();
...
export const updateRole = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        const updaterCollab = await ctx.db
            .query('itineraryCollaborators')
            .withIndex('by_itinerary_user', (q) => q.eq('itineraryId', args.itineraryId).eq('userId', args.updatedBy))
            .first();
