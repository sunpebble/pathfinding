 ...
 */
export const cleanupExpiredOtps: RegisteredMutation<'internal', any, { cleanedOtps: number }> = internalMutation({
 ...
 */
export const cleanupExpiredRateLimits: RegisteredMutation<'internal', any, { cleaned: number }> = internalMutation({
