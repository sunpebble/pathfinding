...
export const getByTippingCulture = query({
    args: {
        culture: v.union(v.literal('expected'), v.literal('appreciated'), v.literal('optional'), v.literal('not_expected'), v.literal('offensive')),
    },
    handler: async (ctx, args) => {
        return await ctx.db
            .query('tippingGuides')
            .withIndex('by_tipping_culture', (q) => q.eq('tippingCulture', args.culture))
            .collect();
    },
});
...
export const searchByName = query({
    ...
    handler: async (ctx, args) => {
        ...
        return guides.filter((guide) => guide.countryName.toLowerCase().includes(searchLower) ||
...
export const getScenario = query({
    args: {
        ...
        scenarioType: v.union(v.literal('restaurant'), v.literal('hotel'), v.literal('taxi'), v.literal('bar'), v.literal('spa'), v.literal('tour'), v.literal('delivery'), v.literal('hairdresser'), v.literal('other')),
    },
    handler: async (ctx, args) => {
...
export const create = mutation({
    args: {
        ...
        tippingCulture: v.union(v.literal('expected'), v.literal('appreciated'), v.literal('optional'), v.literal('not_expected'), v.literal('offensive')),
        cultureSummary: v.string(),
        scenarios: v.array(v.object({
            type: v.union(v.literal('restaurant'), v.literal('hotel'), v.literal('taxi'), v.literal('bar'), v.literal('spa'), v.literal('tour'), v.literal('delivery'), v.literal('hairdresser'), v.literal('other')),
            typeName: v.string(),
...
export const update = mutation({
    args: {
        ...
        tippingCulture: v.optional(v.union(v.literal('expected'), v.literal('appreciated'), v.literal('optional'), v.literal('not_expected'), v.literal('offensive'))),
        ...
        const initialData = [
            {
                ...
                cultureSummary: '美国是全球小费文化最盛行的国家之一。服务业从业者的基本工资较低，小费是其主要收入来源。不给小费被视为非常不礼貌的行为。',
                scenarios: [
                    {
                        type: 'restaurant',
                        typeName: '餐厅',
            ...
            },
            {
                ...
                cultureSummary: '日本没有小费文化，给小费可能被视为侮辱。日本人认为提供优质服务是职业道德的体现，不需要额外报酬。',
                scenarios: [
                    {
                        type: 'restaurant',
                        typeName: '餐厅',
            ...
            },
            {
                ...
                currency: 'CNY',
                currencySymbol: '¥',
                tippingCulture: 'not_expected',
                cultureSummary: '中国大陆没有小费文化，大多数场合不需要给小费。高档酒店和涉外场所可能会收取服务费。',
                scenarios: [
                    {
                        type: 'restaurant',
                        typeName: '餐厅',
            ...
            },
            {
                ...
                cultureSummary: '泰国的小费文化介于东西方之间。小费不是必须的，但会受到欢迎。旅游区的小费期望较高。',
                scenarios: [
                    {
                        type: 'restaurant',
                        typeName: '餐厅',
            ...
            },
            {
                ...
                cultureSummary: '法国的服务费通常已包含在账单中（service compris）。额外小费是可选的，用于表示对特别好服务的感谢。',
                scenarios: [
                    {
                        type: 'restaurant',
                        typeName: '餐厅',
            ...
            },
            {
                ...
                currencySymbol: '£',
                tippingCulture: 'appreciated',
                cultureSummary: '英国的小费文化比美国温和。服务费有时已包含在账单中，额外小费是可选的但受欢迎。',
                scenarios: [
                    {
                        type: 'restaurant',
                        typeName: '餐厅',
