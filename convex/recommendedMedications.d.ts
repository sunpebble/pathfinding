 ...
 * 药品清单建议
 */
export declare const listGlobal: import("convex/server").RegisteredQuery<"public", {}, Promise<({
...
export declare const listByPriority: import("convex/server").RegisteredQuery<"public", {
...
export declare const getById: import("convex/server").RegisteredQuery<"public", {
    id: import("convex/values").GenericId<"recommendedMedications">;
}, Promise<{
    _id: import("convex/values").GenericId<"expenseCategories">;
    _creationTime: number;
    name: string;
