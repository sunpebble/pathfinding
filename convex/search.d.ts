 ...
 */
export declare const globalSearch: import("convex/server").RegisteredQuery<"public", {
    limit?: number | undefined;
    cityId?: import("convex/values").GenericId<"cities"> | undefined;
    types?: ("user" | "itinerary" | "poi" | "guide")[] | undefined;
    query: string;
}, Promise<{
    results: {
        id: string;
 ...
 */
export declare const recordSearchHistory: import("convex/server").RegisteredMutation<"public", {
    resultType?: "user" | "itinerary" | "poi" | "guide" | undefined;
 ...
 */
export declare const getSearchHistory: import("convex/server").RegisteredQuery<"public", {
    limit?: number | undefined;
    userId: string;
}, Promise<{
    history: {
        id: import("convex/values").GenericId<"cities"> | import("convex/values").GenericId<"pois"> | import("convex/values").GenericId<"userSubmittedPois"> | import("convex/values").GenericId<"itineraryItems"> | import("convex/values").GenericId<"itineraries"> | import("convex/values").GenericId<"itineraryDays"> | import("convex/values").GenericId<"crawlJobs"> | import("convex/values").GenericId<"poiSourceMappings"> | import("convex/values").GenericId<"poiTickets"> | import("convex/values").GenericId<"normalizedPois"> | import("convex/values").GenericId<"rawCrawlRecords"> | import("convex/values").GenericId<"trainingDatasets"> | import("convex/values").GenericId<"itineraryComments"> | import("convex/values").GenericId<"guideComments"> | import("convex/values").GenericId<"favoriteCollections"> | import("convex/values").GenericId<"conversations"> | import("convex/values").GenericId<"messages"> | import("convex/values").GenericId<"expenseCategories"> | import("convex/values").GenericId<"travelGuides"> | import("convex/values").GenericId<"insuranceProducts"> | import("convex/values").GenericId<"chatSessions"> | import("convex/values").GenericId<"emergencyContacts"> | import("convex/values").GenericId<"wifiSpots"> | import("convex/values").GenericId<"wifiReviews"> | import("convex/values").GenericId<"chargingStations"> | import("convex/values").GenericId<"simCards"> | import("convex/values").GenericId<"simCardReviews"> | import("convex/values").GenericId<"travelNotes"> | import("convex/values").GenericId<"noteComments"> | import("convex/values").GenericId<"verificationBadges"> | import("convex/values").GenericId<"packingTemplates"> | import("convex/values").GenericId<"packingLists"> | import("convex/values").GenericId<"tripMembers"> | import("convex/values").GenericId<"sharedExpenses"> | import("convex/values").GenericId<"templateCategories"> | import("convex/values").GenericId<"itineraryTemplates"> | import("convex/values").GenericId<"travelPartnerRequests"> | import("convex/values").GenericId<"partnerMatchApplications"> | import("convex/values").GenericId<"poiAnswers"> | import("convex/values").GenericId<"poiQuestions"> | import("convex/values").GenericId<"answerComments"> | import("convex/values").GenericId<"offlineTranslationPacks"> | import("convex/values").GenericId<"poiPhotos"> | import("convex/values").GenericId<"flights"> | import("convex/values").GenericId<"visaRequirements"> | import("convex/values").GenericId<"shareLinks"> | import("convex/values").GenericId<"flightBookings"> | import("convex/values").GenericId<"localEvents"> | import("convex/values").GenericId<"eventReviews"> | import("convex/values").GenericId<"foodReviews"> | import("convex/values").GenericId<"foodCollections"> | import("convex/values").GenericId<"users"> | import("convex/values").GenericId<"authSessions"> | import("convex/values").GenericId<"authRefreshTokens"> | import("convex/values").GenericId<"authAccounts"> | import("convex/values").GenericId<"profiles"> | import("convex/values").GenericId<"userFollows"> | import("convex/values").GenericId<"activityFeed"> | import("convex/values").GenericId<"cityEncyclopedia"> | import("convex/values").GenericId<"userTimezoneSettings"> | import("convex/values").GenericId<"userSubmittedPoiVotes"> | import("convex/values").GenericId<"hiddenGemRatings"> | import("convex/values").GenericId<"poiHolidayHours"> | import("convex/values").GenericId<"poiBusinessHoursReminders"> | import("convex/values").GenericId<"itineraryCollaborators"> | import("convex/values").GenericId<"collaboratorPresence"> | import("convex/values").GenericId<"editOperations"> | import("convex/values").GenericId<"itineraryCopyHistory"> | import("convex/values").GenericId<"reminders"> | import("convex/values").GenericId<"ticketReminders"> | import("convex/values").GenericId<"poiReviews"> | import("convex/values").GenericId<"dataQualityReports"> | import("convex/values").GenericId<"guideCommentLikes"> | import("convex/values").GenericId<"commentLikes"> | import("convex/values").GenericId<"commentReports"> | import("convex/values").GenericId<"notifications"> | import("convex/values").GenericId<"pushTokens"> | import("convex/values").GenericId<"notificationSettings"> | import("convex/values").GenericId<"scheduledNotifications"> | import("convex/values").GenericId<"itineraryLikes"> | import("convex/values").GenericId<"itineraryFavorites"> | import("convex/values").GenericId<"messageReadStatus"> | import("convex/values").GenericId<"hotelBookings"> | import("convex/values").GenericId<"itineraryBudgets"> | import("convex/values").GenericId<"expenses"> | import("convex/values").GenericId<"calendarSyncs"> | import("convex/values").GenericId<"guideRecommendations"> | import("convex/values").GenericId<"visitedCities"> | import("convex/values").GenericId<"visitedCountries"> | import("convex/values").GenericId<"travelStats"> | import("convex/values").GenericId<"luggage"> | import("convex/values").GenericId<"userInsurance"> | import("convex/values").GenericId<"destinationRiskProfiles"> | import("convex/values").GenericId<"insuranceClaimGuides"> | import("convex/values").GenericId<"chatMessages"> | import("convex/values").GenericId<"tippingGuides"> | import("convex/values").GenericId<"travelBlogPosts"> | import("convex/values").GenericId<"emergencyServices"> | import("convex/values").GenericId<"travelInsurance"> | import("convex/values").GenericId<"sosAlerts"> | import("convex/values").GenericId<"safetyRatings"> | import("convex/values").GenericId<"safetyAlerts"> | import("convex/values").GenericId<"dangerZones"> | import("convex/values").GenericId<"wifiCredentials"> | import("convex/values").GenericId<"wifiReviewHelpful"> | import("convex/values").GenericId<"safetyIncidentReports"> | import("convex/values").GenericId<"chargingStationReviews"> | import("convex/values").GenericId<"favoriteChargingStations"> | import("convex/values").GenericId<"simCardReviewVotes"> | import("convex/values").GenericId<"favoriteSimCards"> | import("convex/values").GenericId<"noteImages"> | import("convex/values").GenericId<"noteTags"> | import("convex/values").GenericId<"notePois"> | import("convex/values").GenericId<"noteLikes"> | import("convex/values").GenericId<"noteCommentLikes"> | import("convex/values").GenericId<"noteSaves"> | import("convex/values").GenericId<"userTravelStats"> | import("convex/values").GenericId<"yearlyReviews"> | import("convex/values").GenericId<"verificationApplications"> | import("convex/values").GenericId<"weatherCache"> | import("convex/values").GenericId<"packingItems"> | import("convex/values").GenericId<"expenseParticipants"> | import("convex/values").GenericId<"settlements"> | import("convex/values").GenericId<"templateLikes"> | import("convex/values").GenericId<"templateSaves"> | import("convex/values").GenericId<"itineraryDrafts"> | import("convex/values").GenericId<"userTravelPreferences"> | import("convex/values").GenericId<"partnerMatches"> | import("convex/values").GenericId<"userVerifications"> | import("convex/values").GenericId<"userTrustScores"> | import("convex/values").GenericId<"partnerRequestSaves"> | import("convex/values").GenericId<"answerVotes"> | import("convex/values").GenericId<"questionFollowers"> | import("convex/values").GenericId<"questionReports"> | import("convex/values").GenericId<"answerReports"> | import("convex/values").GenericId<"translationPhrases"> | import("convex/values").GenericId<"savedTranslations"> | import("convex/values").GenericId<"userOfflinePacks"> | import("convex/values").GenericId<"poiPhotoLikes"> | import("convex/values").GenericId<"userVisaReminders"> | import("convex/values").GenericId<"visaApplications"> | import("convex/values").GenericId<"visaCenters"> | import("convex/values").GenericId<"shareEvents"> | import("convex/values").GenericId<"shareEventLogs"> | import("convex/values").GenericId<"luggageLossReportTemplates"> | import("convex/values").GenericId<"eventFavorites"> | import("convex/values").GenericId<"eventReminders"> | import("convex/values").GenericId<"eventReviewVotes"> | import("convex/values").GenericId<"userPreferences"> | import("convex/values").GenericId<"userBehaviorEvents"> | import("convex/values").GenericId<"itineraryVersions"> | import("convex/values").GenericId<"poiQuestionsExtended"> | import("convex/values").GenericId<"poiAnswersExtended"> | import("convex/values").GenericId<"poiQuestionVotes"> | import("convex/values").GenericId<"poiAnswerVotes"> | import("convex/values").GenericId<"poiQAReports"> | import("convex/values").GenericId<"contentTranslations"> | import("convex/values").GenericId<"otpCodes"> | import("convex/values").GenericId<"rateLimits"> | import("convex/values").GenericId<"foodReviewHelpful"> | import("convex/values").GenericId<"foodFavorites"> | import("convex/values").GenericId<"currencyRates"> | import("convex/values").GenericId<"currencyHistory"> | import("convex/values").GenericId<"agentSessions"> | import("convex/values").GenericId<"agentCheckpoints"> | import("convex/values").GenericId<"authVerificationCodes"> | import("convex/values").GenericId<"authVerifiers"> | import("convex/values").GenericId<"authRateLimits">;
        query: any;
        resultType: any;
        resultId: any;
        searchedAt: any;
 ...
 */
export declare const clearSearchHistory: import("convex/server").RegisteredMutation<"public", {
    userId: string;
}, Promise<{
    deleted: number;
}>>;
 ...
 */
export declare const deleteSearchHistoryItem: import("convex/server").RegisteredMutation<"public", {
    id: import("convex/values").GenericId<"searchHistory">;
    userId: string;
}, Promise<void>>;
/**
 * Record search for trending analytics
 */
export declare const recordSearchTrend: import("convex/server").RegisteredMutation<"public", {
    resultType?: "user" | "itinerary" | "poi" | "guide" | undefined;
    query: string;
}, Promise<import("convex/values").GenericId<import("convex/server").TableNamesInDataModel<{
    messages: {
 ...
 */
export declare const getTrendingSearches: import("convex/server").RegisteredQuery<"public", {
    limit?: number | undefined;
