...
export const listByRiskLevel = query({
    args: {
        riskLevel: v.union(v.literal('low'), v.literal('moderate'), v.literal('high'), v.literal('extreme')),
    },
    handler: async (ctx, args) => {
        return await ctx.db
            .query('healthAdvisories')
...
export const listByCategory = query({
    args: {
        category: v.union(v.literal('disease_outbreak'), v.literal('environmental'), v.literal('food_water'), v.literal('insect_borne'), v.literal('altitude'), v.literal('climate'), v.literal('general')),
    },
    handler: async (ctx, args) => {
        return await ctx.db
            .query('healthAdvisories')
...
export const create = mutation({
    args: {
        ...
        seasonalRisk: v.optional(v.object({
...
export const update = mutation({
    args: {
        ...
        riskLevel: v.optional(v.union(v.literal('low'), v.literal('moderate'), v.literal('high'), v.literal('extreme'))),
        title: v.optional(v.string()),
        description: v.optional(v.string()),
        category: v.optional(v.union(v.literal('disease_outbreak'), v.literal('environmental'), v.literal('food_water'), v.literal('insect_borne'), v.literal('altitude'), v.literal('climate'), v.literal('general'))),
        symptoms: v.optional(v.array(v.string())),
