...
import { Itinerary, ItineraryDay, ItineraryItem, Poi, City, Reminder, SyncQueue } from "./models";
...
export const database = new Database({
  adapter,
  modelClasses: [Itinerary, ItineraryDay, ItineraryItem, Poi, City, Reminder, SyncQueue],
});
