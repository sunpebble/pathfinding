...
- **探路 Monorepo**: `apps/mobile/src/`, `apps/api/src/`, `packages/*/src/`
...
- **Tests**: `apps/mobile/__tests__/`, `apps/api/tests/`
- Paths shown below assume monorepo structure - adjust based on plan.md
...
- [ ] T009 Setup Sentry error tracking for mobile app and backend
- [ ] T010 [P] Implement location services permission handling (iOS/Android)
- [ ] T011 [P] Configure ESLint, Prettier, Commitlint with Husky pre-commit hooks
- [ ] T012 Setup shared TypeScript types package (`packages/types`)
- [ ] T013 Configure Turborepo build pipeline with caching
