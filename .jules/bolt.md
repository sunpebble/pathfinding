...
**Action:** When optimizing Convex queries, inspect the *logic* of the filter (e.g., `q.eq(q.field('email'), ...)`) to identify the correct index, regardless of variable names.
