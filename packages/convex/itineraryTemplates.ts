...
const templateDayValidator = v.object({
  dayNumber: v.number(),
...
export const createTemplate = mutation({
  args: {
    ...
    daysCount: v.number(),
    days: v.array(templateDayValidator),
...
export const updateTemplate = mutation({
  args: {
    ...
    days: v.optional(v.array(templateDayValidator)),
    destinations: v.optional(v.array(v.string())),
    tags: v.optional(v.array(v.string())),
    estimatedBudget: v.optional(estimatedBudgetValidator),
    suitableFor: v.optional(v.array(v.string())),
  ...
  handler: async (ctx, args) => {
    ...
    if (template.templateType === 'user' && template.creatorId !== args.userId) {
